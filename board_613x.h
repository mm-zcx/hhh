...
//------- port pins for these 2 signals differ by board type -------
#define PIN_READY   {1 << 2, AT91C_BASE_PIOB, AT91C_ID_PIOB, PIO_INPUT}
#define PIN_ACTIVE  {1 << 9, AT91C_BASE_PIOC, AT91C_ID_PIOC, PIO_INPUT}
//#endif
//-------------------------------------------------------------
...
#define PIN_ACKIRQ {1 << 10, AT91C_BASE_PIOC, AT91C_ID_PIOC, PIO_OUTPUT_0, PIO_DEFAULT}
